  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="p-6 text-center">
        ...
        <h2 className="font-display text-xl font-bold mb-2">Delete Session</h2>
        <p className="text-muted text-sm mb-1">Are you sure you want to delete <strong className="text-txt">"{session.title}"</strong>?</p>
